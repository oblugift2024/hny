...
let duration = 5000;
let str = ['OBLUGIFT', 'HAPPY', 'NEW', 'YEAR', '2025'];
...
function init() {
    ...
    // Ensure the canvas doesn't have a background color
...
function render(t) {
    ...
    // Remove the black background filling to make it transparent
    ctx.clearRect(0, 0, w, h); // This clears the canvas without filling it with any color
